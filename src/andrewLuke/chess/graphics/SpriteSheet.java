...
public final class SpriteSheet
{
    ...
    public static SpriteSheet spriteSheet = new SpriteSheet("MilitantSpriteSheet.png", 600, 75);
     ...
     *
     * @precondition the specified path is correct, as are the dimensions
     * @postcondition the spriteSheet's ssPixelArray contains the pixel data for
     * all Sprites
